...
public class DishAdapter extends BaseAdapter {
	...
	public DishAdapter(Context context, ArrayList<Dish> dish) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.layout_gridview_dish, null);
		...
		ImageLoader.getInstance().displayImage(avatarUrl, holder.dishpic,
				MyApplication.getInstance().getOptions(R.drawable.defaultdishpic), new SimpleImageLoadingListener() {
					...
					public void onLoadingComplete(String imageUri, View view, Bitmap loadedImage) {
						...
						holder.dishpic.setImageBitmap(loadedImage);
					}
